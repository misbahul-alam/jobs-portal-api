...
export const applications = pgTable(
    "applications",
    {
        ...
        resumeId: uuid("resume_id").references(() => resumes.id, { onDelete: "set null" }), // optional
    ...
    (t) => ({
        jobUserUnique: uniqueIndex("job_applications_job_user_unique").on(t.jobId, t.userId),
